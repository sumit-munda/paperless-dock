  ...
  >
    ...
    <div className="flex flex-col gap-4 text-center lg:text-left">
      ...
      <p className="max-w-xl mx-auto lg:mx-0 leading-7 text-muted-foreground">
        ...
        and read eBooks in one seamless experience. With an intuitive reader,
        progress tracking, and a clean interface, it brings paperless reading
        to life for today’s digital readers.
      </p>
